...
We have moved away from a manual CLA signature process in Google forms and are adopting a CLA-Assistant bot in GitHub.  This ensures that the CLA is signed before a PR can be merged into a project branch. 

Please view the Capital One Individual Contributor License agreement below: 
```bash
Capital One Services, LLC Individual Contributor License Agreement v2.0 - https://developer.capitalone.com/open-source/
